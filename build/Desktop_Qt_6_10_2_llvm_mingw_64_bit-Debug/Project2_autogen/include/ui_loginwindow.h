...
public:
    ...
    void setupUi(QMainWindow *LoginWindow)
    {
        ...
        frame_Login->setMinimumSize(QSize(364, 389));
        frame_Login->setMaximumSize(QSize(364, 389));
        frame_Login->setBaseSize(QSize(364, 389));
...
"border-radius: 8px;"));
        ...
        layoutWidget->setGeometry(QRect(15, 15, 331, 361));
...
"text-align: left;"));
        ...
        label_RegPassword->setFont(font2);
...
"text-align: left;"));
        ...
        label_RegRePassword->setFont(font2);
