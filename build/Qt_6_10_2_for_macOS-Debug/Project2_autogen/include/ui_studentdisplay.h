...
"	border: 1px solid #006747; \n"
"}"));
        widget_ClassSchedule = new QWidget(page_ClassSchedule);
        widget_ClassSchedule->setObjectName("widget_ClassSchedule");
        widget_ClassSchedule->setGeometry(QRect(260, 50, 1125, 825));
        sizePolicy1.setHeightForWidth(widget_ClassSchedule->sizePolicy().hasHeightForWidth());
        widget_ClassSchedule->setSizePolicy(sizePolicy1);
        widget_ClassSchedule->setMinimumSize(QSize(1125, 825));
        widget_ClassSchedule->setMaximumSize(QSize(1125, 825));
        widget_ClassSchedule->setStyleSheet(QString::fromUtf8("QWidget#widget_ClassSchedule {\n"
"background-color: white;\n"
"border-radius: 25px;\n"
"}"));
        gridLayout_3 = new QGridLayout(widget_ClassSchedule);
...
"}"));
        ...
        widget_Register = new QWidget(page_Register);
        widget_Register->setObjectName("widget_Register");
        widget_Register->setGeometry(QRect(260, 50, 1125, 825));
        sizePolicy1.setHeightForWidth(widget_Register->sizePolicy().hasHeightForWidth());
        widget_Register->setSizePolicy(sizePolicy1);
        widget_Register->setMinimumSize(QSize(1125, 825));
        widget_Register->setMaximumSize(QSize(1125, 825));
        widget_Register->setStyleSheet(QString::fromUtf8("QWidget#widget_Register {\n"
"background-color: white;\n"
"border-radius: 25px;\n"
"}"));
...
"}"));
        ...
        widget_ViewPlans = new QWidget(page_ViewPlans);
        widget_ViewPlans->setObjectName("widget_ViewPlans");
        widget_ViewPlans->setGeometry(QRect(260, 50, 1125, 825));
        sizePolicy1.setHeightForWidth(widget_ViewPlans->sizePolicy().hasHeightForWidth());
        widget_ViewPlans->setSizePolicy(sizePolicy1);
        widget_ViewPlans->setMinimumSize(QSize(1125, 825));
        widget_ViewPlans->setMaximumSize(QSize(1125, 825));
        widget_ViewPlans->setStyleSheet(QString::fromUtf8("QWidget#widget_ViewPlans {\n"
"background-color: white;\n"
"border-radius: 25px;\n"
"}"));
...
"}"));
        ...
        widget_SearchCourses = new QWidget(page_SearchCourses);
        widget_SearchCourses->setObjectName("widget_SearchCourses");
        widget_SearchCourses->setGeometry(QRect(260, 50, 1125, 825));
        widget_SearchCourses->setMinimumSize(QSize(1125, 825));
        widget_SearchCourses->setMaximumSize(QSize(1125, 825));
        widget_SearchCourses->setStyleSheet(QString::fromUtf8("QWidget#widget_SearchCourses {\n"
"background-color: white;\n"
"border-radius: 25px;\n"
"}"));
