...
template <> constexpr inline auto Room::qt_create_metaobjectdata<qt_meta_tag_ZN4RoomE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Room, qt_meta_tag_ZN4RoomE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
void *Room::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4RoomE_t>.strings))
